...
# The integration suite uses marker values (NOTIF-MARKER-PW-*, NOTIF-MARKER-SEED-*)
# for every password and seed it stores; a share link always contains
# /notification/share[/#]<43 chars>.
set -euo pipefail
...
n=0; for pat in 'NOTIF-MARKER-PW-' 'NOTIF-MARKER-SEED-' '/notification/share[/#][A-Za-z0-9_-]\{43\}' 'otpauth://' '-----BEGIN' 'eyJhbGciOiJFZERTQSI'; do
