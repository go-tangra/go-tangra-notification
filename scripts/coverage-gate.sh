#!/usr/bin/env bash
# Service coverage gate: >=80% overall, 100% for the packages that hold
# credentials, render templates, serve streams or decide access.
set -euo pipefail
PROFILE="${1:-coverage.out}"
MODULE="github.com/go-freya/freya/services/notification"
SECURITY_PKGS=("internal/authz" "internal/render" "internal/sealed" "internal/stream" "internal/channel/email")
