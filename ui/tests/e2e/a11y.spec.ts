...
// T070 / SC-006: every notification view inside the shell, both themes, zero serious or
...
const routes = ['/notification/inbox',  '/notification/channels',  '/notification/templates',  '/notification/log',  '/notification/messages',  '/notification/categories',  '/notification/permissions']
