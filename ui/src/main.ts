// Standalone development entry: mounts the notification routes in a bare kit shell
...
const app = createApp({ render: () => h(UiAppShell, { title: 'notification (dev)', hideNav: true }, () => h(RouterView)) })
app.use(createPinia())
