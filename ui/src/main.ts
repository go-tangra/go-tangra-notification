// Standalone development entry: mounts the notification routes in a bare
// Vuetify app against the gateway (npm run dev). In the platform the shell
// mounts ./routes, ./nav and ./header from the federated remote instead.
