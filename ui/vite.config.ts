...
// The notification UI is a federated remote served by the module under /ui/ and
// relayed by the gateway at /m/notification/; `vite` alone runs a standalone dev
...
export default defineConfig({
  ...
  test: {
    environment: 'jsdom',
    environmentOptions: { jsdom: { url: 'https://localhost/notification' } },
