...
// Validate checks the field values on NotificationPermission with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *NotificationPermission) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on NotificationPermission with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// NotificationPermissionMultiError, or nil if none found.
func (m *NotificationPermission) ValidateAll() error {
	return m.validate(true)
}

func (m *NotificationPermission) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, NotificationPermissionValidationError{
					field:  "CreateTime",
		...
		if err := v.Validate(); err != nil {
			return NotificationPermissionValidationError{
				field:  "CreateTime",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return NotificationPermissionMultiError(errors)
	}

	return nil
}

// NotificationPermissionMultiError is an error wrapping multiple validation
// errors returned by NotificationPermission.ValidateAll() if the designated
// constraints aren't met.
type NotificationPermissionMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m NotificationPermissionMultiError) Error() string {
...
func (m NotificationPermissionMultiError) AllErrors() []error { return m }

// NotificationPermissionValidationError is the validation error returned by
// NotificationPermission.Validate if the designated constraints aren't met.
type NotificationPermissionValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
func (e NotificationPermissionValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e NotificationPermissionValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e NotificationPermissionValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e NotificationPermissionValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e NotificationPermissionValidationError) ErrorName() string {
	return "NotificationPermissionValidationError"
}

// Error satisfies the builtin error interface
func (e NotificationPermissionValidationError) Error() string {
	cause := ""
	if e.cause != nil {
	...
	return fmt.Sprintf(
		"invalid %sNotificationPermission.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = NotificationPermissionValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = NotificationPermissionValidationError{}
