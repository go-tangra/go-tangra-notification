...
// Reserved event types only the module itself publishes.
var Reserved = map[string]bool{"inbox": true, "inbox.revoked": true, "reset": true, "bye": true}
...
func Key(tenantID string) string { return "notif:events:" + tenantID }
