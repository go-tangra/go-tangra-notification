...
// Refusals (contracts/notification-api.openapi.yaml). ErrValidation and
// ErrConflict may carry a detail object through WriteDetail.
var (
...
// WriteDetail emits {"reason": ..., "detail": {...}} (validation positions,
// conflicting counts); detail values are never secrets.
...
// reasons, oversized bodies to 413, anything else to 503
